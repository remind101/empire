...
PARAMETERS="ParameterKey=DesiredCapacity,ParameterValue=2 ParameterKey=AvailabilityZones,ParameterValue=\"$SAFEZONES\" ParameterKey=KeyName,ParameterValue=\"$keyname\" ParameterKey=LaunchEmpire,ParameterValue=false"
